...
class Config {
  ...
  /// Returns a Map suitable for attaching to [params] and posting to the Transistor Software Demo Server at `http://200.132.92.82:3000`.
  ///
  ///
  /// ## Example
  ///
  ...
  ///
  /// BackgroundGeolocation.ready(Config(
  ///   url: 'http://200.132.92.82:3000/locations/$username',
  ///   params: deviceParams
  /// ));
  /// ```
  ///
  /// View your tracking at [http://200.132.92.82:3000/my-unique-username](http://200.132.92.82:3000/my-unique-username).
  ///
